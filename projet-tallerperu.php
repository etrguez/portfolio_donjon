...
<body>
  ...
  <div class="projet-detail">
    <div class="card detail-card">
      ...
      <p>
        <?php echo trans('Taller Perú est un site professionnel pour un garage automobile spécialisé à Las Palmas. La plateforme combine une interface client intuitive pour consulter les services et promotions avec un puissant panel administrateur pour gérer dynamiquement les offres promotionnelles. Ce projet démontre une gestion complète de contenu avec optimisation d\'images avancée.', 'Taller Perú es un sitio profesional para un garage automotriz especializado en Las Palmas. La plataforma combina una interfaz intuitiva del cliente para consultar servicios y promociones con un poderoso panel de administrador para gestionar dinámicamente las ofertas promocionales. Este proyecto demuestra una gestión completa de contenido con optimización de imágenes avanzada.', 'Taller Perú is a professional website for a specialized automotive garage in Las Palmas. The platform combines an intuitive client interface to view services and promotions with a powerful admin panel to dynamically manage promotional offers. This project demonstrates complete content management with advanced image optimization.'); ?>
      </p>
