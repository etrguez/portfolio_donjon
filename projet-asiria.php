  ...
  <div class="projet-detail">
    <div class="card detail-card">
      ...
      <div class="projet-meta">
        ...
        <p><strong><?php echo getText('Développé par', 'Desarrollado por', 'Developed by'); ?> :</strong> KDevs (Babou CAMARA-DIABY & Elisabeth TALAVERA RODRIGUEZ)</p>
      </div>
      ...
      <ul>
        <li>📖 <strong><?php echo getText('Bio interactive', 'Bio interactiva', 'Interactive bio'); ?> :</strong> <?php echo getText('Section expandable (Ver más/Ver menos)', 'Sección expandible (Ver más/Ver menos)', 'Expandable section (Read more/Less)'); ?></li>
        <li>📸 <strong><?php echo getText('3 Galeries', '3 Galerías', '3 Galleries'); ?> :</strong> <?php echo getText('Fotografía, Diseño Gráfico, Otros Proyectos (collaborations, événements, workshops)', 'Fotografía, Diseño Gráfico, Otros Proyectos (colaboraciones, eventos, talleres)', 'Photography, Graphic Design, Other Projects (collaborations, events, workshops)'); ?></li>
        <li>🖼️ <strong><?php echo getText('Projets détaillés', 'Proyectos detallados', 'Detailed projects'); ?> :</strong> <?php echo getText('Images/vidéos HD, descriptions, dates, clients, navigation fluide', 'Imágenes/videos HD, descripciones, fechas, clientes, navegación fluida', 'HD images/videos, descriptions, dates, clients, smooth navigation'); ?></li>
        <li>💌 <strong><?php echo t('contact_submit'); ?> :</strong> <?php echo getText('Formulaire avec confirmation email auto', 'Formulario con confirmación de correo automática', 'Form with auto email confirmation'); ?></li>
        <li>📋 <strong><?php echo getText('Légal', 'Legal', 'Legal'); ?> :</strong> RGPD, <?php echo getText('mentions légales', 'avisos legales', 'legal notices'); ?> | 🔗 <strong>Social :</strong> Instagram <?php echo getText('intégré', 'integrado', 'integrated'); ?></li>
      </ul>

      <h3><?php echo t('project_admin_panel'); ?></h3>
      <p><?php echo getText('Accès sécurisé', 'Acceso seguro', 'Secure access'); ?> <code>admin/admin.php</code> <?php echo getText('avec authentification robuste :', 'con autenticación robusta:', 'with robust authentication:'); ?></p>

      <div class="galerie-backend">
        <h4><?php echo getText('Gestion Contenu & Analytics', 'Gestión de Contenido y Analytics', 'Content Management & Analytics'); ?></h4>
        <div class="backend-info">
          <div class="backend-item">
            <h5>📝 <?php echo getText('Biographie & 3 Galeries', 'Biografía y 3 Galerías', 'Biography & 3 Galleries'); ?></h5>
            <p><?php echo getText('Créer/éditer bio avec images. Gestion complète Fotografías, Diseños Gráficos, Otros Proyectos. Upload médias, définition image principale, catégorisation flexible.', 'Crear/editar bio con imágenes. Gestión completa Fotografías, Diseños Gráficos, Otros Proyectos. Carga de medios, definición de imagen principal, categorización flexible.', 'Create/edit bio with images. Full management of Photography, Graphic Designs, Other Projects. Media upload, main image definition, flexible categorization.'); ?></p>
          </div>

          <div class="backend-item">
            <h5>📹 <?php echo getText('Gestion Médias', 'Gestión de Medios', 'Media Management'); ?></h5>
            <p><?php echo getText('Upload centralisé images/vidéos. Titres, descriptions. Marquage "principal". Drag-and-drop réorganisation. Suppression sécurisée.', 'Carga centralizada de imágenes/videos. Títulos, descripciones. Marcado "principal". Reorganización con arrastrar y soltar. Eliminación segura.', 'Centralized image/video upload. Titles, descriptions. "Main" marking. Drag-and-drop reorganization. Secure deletion.'); ?></p>
          </div>

          <div class="backend-item">
            <h5>📊 <?php echo getText('Analytics Géographiques', 'Analytics Geográficas', 'Geographic Analytics'); ?></h5>
            <p><?php echo getText('Visites totales, visiteurs uniques, moyenne. Répartition pays/ville. Carte interactive. Sélection mois. Export PDF rapports.', 'Visitas totales, visitantes únicos, promedio. Distribución país/ciudad. Mapa interactivo. Selección de mes. Exportación de informes PDF.', 'Total visits, unique visitors, average. Country/city distribution. Interactive map. Month selection. PDF report export.'); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="galerie-backend">
        <div class="backend-info">
          <div class="backend-item">
            <h5>🔌 PHP 7/8 + MySQL</h5>
            <p><?php echo getText('PDO sécurisé, CRUD modulaire. Tables : users, bio, 3 galeries, medias, stats, sessions. Relations normalisées, indexes performance.', 'PDO seguro, CRUD modular. Tablas: usuarios, bio, 3 galerías, medios, estadísticas, sesiones. Relaciones normalizadas, índices de rendimiento.', 'Secure PDO, modular CRUD. Tables: users, bio, 3 galleries, media, stats, sessions. Normalized relationships, performance indexes.'); ?></p>
          </div>

          <div class="backend-item">
            <h5>🔐 <?php echo t('feature_security'); ?> & <?php echo getText('Emails', 'Correos', 'Emails'); ?></h5>
            <p><?php echo getText('Sessions tokens, bcrypt, sanitization, prepared statements. Mailing confirmations contact. Templates pros. Gestion erreurs.', 'Tokens de sesión, bcrypt, sanitización, declaraciones preparadas. Confirmaciones de correo de contacto. Plantillas profesionales. Gestión de errores.', 'Session tokens, bcrypt, sanitization, prepared statements. Contact email confirmations. Professional templates. Error handling.'); ?></p>
          </div>

          <div class="backend-item">
            <h5>☁️ <?php echo getText('Médias & Performance', 'Medios y Rendimiento', 'Media & Performance'); ?></h5>
            <p><?php echo getText('Upload sécurisé, validation types. Optimisation images, lazy-loading. Tailwind CSS responsive. Lightbox/carousel. SEO optimisé.', 'Carga segura, validación de tipos. Optimización de imágenes, carga perezosa. CSS Tailwind responsivo. Lightbox/carrusel. SEO optimizado.', 'Secure upload, type validation. Image optimization, lazy-loading. Responsive Tailwind CSS. Lightbox/carousel. Optimized SEO.'); ?></p>
          </div>
        </div>
      </div>

      <h3><?php echo t('project_key_points'); ?> & <?php echo getText('Collaboration', 'Colaboración', 'Collaboration'); ?></h3>
      <ul>
        <li><strong><?php echo getText('Multi-projets', 'Multi-proyectos', 'Multi-projects'); ?> :</strong> 3 types with distinct logics</li>
        <li><strong><?php echo getText('Médias flexibles', 'Medios flexibles', 'Flexible media'); ?> :</strong> <?php echo getText('Images principales/galerie, pagination', 'Imágenes principales/galería, paginación', 'Main images/gallery, pagination'); ?></li>
        <li><strong>Analytics :</strong> <?php echo getText('Tracking IP, carte interactive, export business', 'Seguimiento de IP, mapa interactivo, exportación comercial', 'IP tracking, interactive map, business export'); ?></li>
        <li><strong>KDevs :</strong> <?php echo getText('Développé avec Babou CAMARA-DIABY (architecture/UX)', 'Desarrollado con Babou CAMARA-DIABY (arquitectura/UX)', 'Developed with Babou CAMARA-DIABY (architecture/UX)'); ?></li>
      </ul>
